...
export default function PokemonCard({
    ...
    return (
        <div className="flex flex-col gap-[14px] p-[18px] w-[260px] h-max items-center border border-[var(--color-neutral-line)] rounded-lg shadow-[var(--elevation-card)] bg-white">
            ...
            <span
                className="font-bold text-[18px] text-[var(--color-text-primary)]"
                lang="ko"
            >
                {name}
            </span>
            <span
                className="justify-center w-max text-[13px] text-[var(--color-text-inverse)] font-semibold font-['Noto_Sans_KR'] px-[14px] py-[9px] rounded-full"
